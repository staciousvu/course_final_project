...
public class ReviewService {
    ...
    public CourseReviewResponse editReviewForCourse(CourseReviewRequest courseReviewRequest){
        ...
        CourseReview courseReview = courseReviewRepository.findByCourseIdAndUserEmail(email,courseId)
    ...
    private CourseReviewResponse mapToResponse(CourseReview courseReview) {
        return CourseReviewResponse.builder()
                .reviewerName(courseReview.getUser().getFirstName() + " " + courseReview.getUser().getLastName())
